...
public class SyncProducer2 {
    public static void main(String[] args) throws Exception {
        DefaultMQProducer producer = new DefaultMQProducer("syncProducer2");
        producer.setNamesrvAddr("49.233.26.33:9876");
        producer.start();
        for (int i = 1; i < 10; i++) {
            Message message = new Message("myTopicA", "tag2", ("Hi 我是顺序发送!(tag2)" + i + " 时间:" + LocalDateTime.now()).getBytes());
